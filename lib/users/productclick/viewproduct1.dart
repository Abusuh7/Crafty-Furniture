...
class ProductView1Page extends StatefulWidget {
  const ProductView1Page({
    Key? key,
  ...
  @override
  State<ProductView1Page> createState() => _ProductView1ShowState();
}

class _ProductView1ShowState extends State<ProductView1Page> {
